 ...
 */
namespace Magenest\Popup\Block\Adminhtml\Product;
...
class Grid extends \Magento\Catalog\Block\Adminhtml\Product\Grid
{
    ...
    {
        return $this->getUrl('magenest_popup/product/productGrid', ['_current' => true]);
    }
    ...
    {
        return $this->getUrl('magenest_popup/product/jsonProductInfo', ['id' => $row->getId()]);
    }
