...
class Display extends \Magento\Framework\View\Element\Template{
    ...
    /** @var \Magenest\Popup\Model\ResourceModel\Template $_templateResource */
    ...
    public function getPopup(){
        ...
        $popupCollections = $this->_popupCollectionFactory->create()
    ...
    public function getTemplateClassDefault($templateId){
        ...
        $this->_templateResource->load($templateModel,$templateId);
