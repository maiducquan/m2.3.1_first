...
class Subscriber extends \Magento\Newsletter\Controller\Subscriber {
    ...
    /** @var  \Magenest\Popup\Model\ResourceModel\Log $_popupLogResource */
    protected $_popupLogResource;
    /**
    ...
    public function __construct(
        ...
        \Magenest\Popup\Model\ResourceModel\Log $popupLogResource,
        ...
        $this->_popupLogResource = $popupResource;
    ...
    public function execute()
    {
        ...
        if (is_array($params)&&!empty($params)) {
            ...
            $popupLogModel->setContent(json_encode($dataPopup));
            $this->_popupLogResource->save($popupLogModel);
        }
